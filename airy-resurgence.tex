...
\end{equation}
The coefficients are straightforward to calculate, but their pattern is hard to describe. For now, we can at least say with confidence that
\begin{align*}
...
and
\begin{align*}
c_n^{(3)} & = \frac{1}{n^3} \frac{5(n+1)}{2} \left(\begin{matrix} n+2 \\ 5 \end{matrix}\right) \\
c_3^{(3)} & = \frac{1}{(n-1)^3} \left(\begin{matrix} n+2 \\ 4 \end{matrix}\right) (2n-5)(n-2) = \frac{1 \cdot 1}{(n-1)^3} \left(\begin{matrix} n+2 \\ 4 \end{matrix}\right) = \frac{1 \cdot 1}{(n-1)^2} \frac{(n+2)(n+1)n}{4!} \\
c_4^{(3)} & = \frac{1}{(n-1)^3} \left(\begin{matrix} n+2 \\ 4 \end{matrix}\right) (2n-5)(n-3) = \frac{3 \cdot 1}{(n-1)^3} \left(\begin{matrix} n+2 \\ 4 \end{matrix}\right) = \frac{3 \cdot 1}{(n-1)^2} \frac{(n+2)(n+1)n}{4!} \sim \frac{3}{1} \cdot \frac{6}{3} \\
c_5^{(3)} & = \frac{1}{(n-1)^3} \left(\begin{matrix} n+2 \\ 4 \end{matrix}\right) (2n-7)(n-3) = \frac{3 \cdot 2}{(n-1)^3} \left(\begin{matrix} n+2 \\ 4 \end{matrix}\right) = \frac{3 \cdot 2}{(n-1)^2} \frac{(n+2)(n+1)n}{4!} \sim \frac{2}{1} \cdot \frac{7}{4} \\
c_6^{(3)} & = \frac{1}{(n-1)^3} \left(\begin{matrix} n+2 \\ 4 \end{matrix}\right) (2n-7)(n-4) = \frac{5 \cdot 2}{(n-1)^3} \left(\begin{matrix} n+2 \\ 4 \end{matrix}\right) \sim \frac{5}{3} \cdot \frac{8}{5} \\
c_7^{(3)} & = \frac{1}{(n-1)^3} \left(\begin{matrix} n+2 \\ 4 \end{matrix}\right) (2n-9)(n-4) = \frac{5 \cdot 3}{(n-1)^3} \left(\begin{matrix} n+2 \\ 4 \end{matrix}\right) \sim \frac{3}{2} \cdot \frac{9}{6} \\
c_8^{(3)} & = \frac{1}{(n-1)^3} \left(\begin{matrix} n+2 \\ 4 \end{matrix}\right) (2n-9)(n-5) = \frac{7 \cdot 3}{(n-1)^3} \left(\begin{matrix} n+2 \\ 4 \end{matrix}\right) \sim \frac{7}{5} \cdot \frac{10}{7} \\
