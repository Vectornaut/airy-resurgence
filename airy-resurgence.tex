...
At $\xi = \infty$, the function $F(a, b, c, \xi)$ is slight, with normal form $(-\xi^{-1})^a f_1 + (-\xi^{-1})^b f_2$~\cite[identity~15.8.2]{dlmf}. At $\xi = 0$, it's holomorphic with order $0$, and at $\xi = 1$ it has the form $h + (1-\xi)^{c-a-b} f$, where $h$ is holomorphic with order $0$~\cite[identity~15.8.4]{dlmf},
