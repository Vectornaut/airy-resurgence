...
where:
\begin{itemize}
%%\item $p$ is a function in $\holoL{\infty, -1}(\Omega)$ that extends holomorphically over $\zeta = 0$, and $1/p$ is in $\holoL{\infty, 1}(\Omega)$.
%%\item $q$ and $r_\lambda$ are functions in $\holoL{\infty}(\Omega)$ that extend holomorphically over $\zeta = 0$.
%%\item $p \in \holoL{\infty, -1}(\Omega)$ and $1/p \in \holoL{\infty, 1}(\Omega)$.
...
%%\item $q, r_\lambda \in \holoL{\infty}(\Omega)$.
...
\textcolor{Indigo}{We want to solve the equation $\mathcal{J}f = 0$. Let's look for a solution of the form $f = \zeta^{\tau-1} + \tilde{f}$ with $\tau \in (0, \infty)$ and $\tilde{f} \in \holoL{\infty, \tau}(\Omega)$.}
...
\tilde{f} & = \left[ -\tfrac{1}{p'_0}\,\zeta^{-1} \circ \tilde{\mathcal{J}} \right]\,\zeta^{\tau-1} + \left[ \tau\,\zeta^{-1} \circ \partial^{-1}_{\zeta \text{ from } 0} - \tfrac{1}{p'_0}\,\zeta^{-1} \circ \tilde{\mathcal{J}} \right]\tilde{f} \\
\end{align*}
...
\holoL{\infty, \rho}(\Omega) \arrow[r, "\tilde{p}", "\|\tilde{p}\|_{\infty, -2}"'] & \holoL{\infty, \rho-2}(\Omega) \arrow[ru, hook, "\|\zeta\|_\infty"'] \arrow[rd, hook, "\|\zeta\|_\infty^2"'] \\
...
& & & \holoL{\infty, \rho}(\Omega) \\
& & & \holoL{\infty, \rho-1}(\Omega) \\
\holoL{\infty, \rho}(\Omega) \arrow[r, "r_\lambda", "\|r_\lambda\|_\infty"'] & \holoL{\infty, \rho}(\Omega) \arrow[r, "\partial^\lambda", "{B(-\lambda, 1-\rho)}"'] & \holoL{\infty, \rho+\lambda}(\Omega) \arrow[ru, hook, "\|\zeta\|_\infty^{-1-\lambda}"'] \arrow[rd, hook, "\|\zeta\|_\infty^{-\lambda}"'] \\
& & & \holoL{\infty, \rho}(\Omega)
\end{tikzcd}
\end{center}
\color{DarkBlue}
...
\begin{align*}
\tilde{\mathcal{J}} & \maps \mathcal{H}L^{\infty, 1-\tau}(\Omega) \to \mathcal{H}L^{\infty, -\tau}(\Omega)\;\text{with} \\
\|\tilde{\mathcal{J}}\| & \le \left(\|\tilde{p}\|_{\infty, -2} + \tfrac{1}{1+\tau}\,\|\tilde{q}\|_{\infty, -1} \right) M + \sum_{\lambda \in \Lambda} B(-\lambda, \tau)\,\|r_\lambda\|_{\infty}\,M^{-1-\lambda}
\end{align*}
and
\begin{align*}
\tilde{\mathcal{J}} & \maps \mathcal{H}L^{\infty, -\tau}(\Omega) \to \mathcal{H}L^{\infty, -1-\tau}(\Omega)\;\text{with} \\
\|\tilde{\mathcal{J}}\| & \le \left(\|\tilde{p}\|_{\infty, -2} + \tfrac{1}{2+\tau}\,\|\tilde{q}\|_{\infty, -1} \right) M + \sum_{\lambda \in \Lambda} B(-\lambda, 1+\tau)\,\|r_\lambda\|_{\infty}\,M^{-1-\lambda}.
\end{align*}
Since $\|\zeta^{-1}\|_{\infty, 1} = 1$, it follows that
\begin{align*}
\zeta^{-1} \circ \tilde{\mathcal{J}} & \maps \mathcal{H}L^{\infty, -\tau}(\Omega) \to \mathcal{H}L^{\infty, -\tau}(\Omega)\;\text{with} \\
\|\zeta^{-1} \circ \tilde{\mathcal{J}}\| & \le \left(\|\tilde{p}\|_{\infty, -2} + \tfrac{1}{2+\tau}\,\|\tilde{q}\|_{\infty, -1} \right) M + \sum_{\lambda \in \Lambda} B(-\lambda, 1+\tau)\,\|r_\lambda\|_{\infty}\,M^{-1-\lambda}.
\end{align*}
