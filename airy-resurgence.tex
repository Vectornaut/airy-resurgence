...
\begin{equation}%%\label{eqn:mod-bessel}
\left[ z^{n-1} \big[ \big({-}\tfrac{\partial}{\partial z}\big)^{n-1} - 1 \big] - c_{n-2} z^{n-2} \big({-}\tfrac{\partial}{\partial z}\big)^{n-2} - \ldots - c_2 z \big({-}\tfrac{\partial}{\partial z}\big)^2 - c_1 z \big({-}\tfrac{\partial}{\partial z}\big) - c_0 \right] \varphi = 0,
\end{equation}
or equivalently
\begin{equation}%%\label{eqn:mod-bessel}
\left[ \big[ \big({-}\tfrac{\partial}{\partial z}\big)^{n-1} - 1 \big] - c_{n-2} z^{-1} \big({-}\tfrac{\partial}{\partial z}\big)^{n-2} - \ldots - c_2 z^{3-n} \big({-}\tfrac{\partial}{\partial z}\big)^2 - c_1 z^{2-n} \big({-}\tfrac{\partial}{\partial z}\big) - c_0 z^{1-n} \right] \varphi = 0,
\end{equation}
\section{Sketches}
