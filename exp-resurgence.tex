...
\mathcal{P} = P(\partial_z) + \frac{1}{z} Q_1(\partial_z) + \frac{1}{z^2}\big[ R_0(z^{-1}) + R_1(z^{-1})\,\partial_z + \ldots + R_d(z^{-1})\,\partial_z^d \b],
\end{equation}
...
\end{theorem}
\textcolor{magenta}{[Paste in statement from {\tt reg-sing-volterra}. Verify the exponent: is it $\tau_j-1$ or $\tau_j$? What are the conditions for $f_j$?]}
