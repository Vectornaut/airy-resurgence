...
\subsubsection{Link to dihedral triangulations}
...
\end{align*}
\color{black}
\subsubsection{Comparison with Ghate and Venkataramana}
\begin{align*}
...
\subsection{Building a distinguished frame of analytic solution}
