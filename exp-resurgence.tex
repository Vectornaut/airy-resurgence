...
\end{equation}
which has zero radius of convergence, but still makes sense as a formal power series. As another example, if you want to construct a holomorphic function $\Phi$ that satisfies the ordinary differential equation (ODE)
\begin{center}
