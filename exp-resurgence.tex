...
& = 4u^3 - 3u + 1 \\
\tau & = 0 \text{ and } u_\tau = 0 \text{ at } u = \tfrac{1}{2} \\
\tfrac{1}{2} \tau^2 & = 6w^2 + 4w^3 \text{ with } u := \tfrac{1}{2} + w \\
I_\alpha(z) & = e^{z\zeta_\alpha} \int_{\tau \in [-\varepsilon, \varepsilon]} e^{-z\tau^2/2} \nu \\
& = e^{-z} \int_{\tau \in [-\varepsilon, \varepsilon]} e^{-z\tau^2/2} \nu
\end{align*}
\begin{align*}
...
\begin{align*}
\tau^2 & = 12w^2 + 8w^3\\
\tau^2 & = 12 a_1^2 \tau^2 & 1 & = 12 a_1^2 \\
0 & = 24 a_1 a_2 \tau^3 + 8a_1^3 \tau^3 & 0 & = 36 a_2 + 12 a_1^2 \\
& & -1 & = 36 a_2 \\
0 & = (24a_1 a_3 + 12 a_2^2) \tau^4 + 24 a_1^2 a_2 \tau^4 & 0 & = 24 a_1 a_3 + 12 a_2^2 + 24 a_1^2 a_2 \\
& & & = 24 a_1 a_3 + 12 a_2^2 + 2 a_2 \\
& & & = 24 a_1 a_3 + \frac{1}{3 \cdot 36} - \frac{1}{18} \\
& & \frac{5}{108} & = 24 a_1 a_3 \\
& & \frac{5}{216} a_1 & = a_3 \\
0 & = (24 a_1 a_4 + 24 a_2 a_3) \tau^5 + (24 a_1 a_2^2 + 24 a_1^2 a_3) \tau^5 & 0 & = 24 a_1 a_4 + 24 a_2 a_3 + 24 a_1 a_2^2 + 2 a_3 \\
& & & = 24 a_1 a_4 + \frac{5}{9} a_2 a_1 + 24 a_1 a_2^2 + \frac{5}{108} a_1 \\
& & 0 & = 24 a_4 + \frac{5}{9} a_2 + 24 a_2^2 + \frac{5}{108} \\
& & 0 & = 24 a_4 - \frac{5}{324} + \frac{1}{54} + \frac{5}{108} \\
& & -\frac{4}{81} & = 24 a_4 \\
& & -\frac{1}{486} & = a_4 \\
\end{align*}
\begin{align*}
