...
Write explicit definition $\mathcal{L}_{\zeta_{\alpha},0}^{\theta}\varphi$ specifying the argument of $\varphi$ in the integration. 

\begin{equation}
\mathcal{L}_{\zeta_\alpha,0}^{\theta}\varphi:=\int_{\Gamma_{\zeta_\alpha,0}^{\theta}}e^{-z\zeta_\alpha}\varphi(\zeta_\alpha-\alpha)d\zeta_\alpha
\end{equation}
