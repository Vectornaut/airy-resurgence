...
is a solution of 
\begin{equation} I''+a I'+bI+c\frac{I'}{z}+\frac{d}{z}I+\frac{e}{z^2}I=0
\end{equation}
...
\end{align*}
where $p=a_3-\frac{a_2^2}{3a_1}$ and $q=a_4-\frac{a_2a_3}{3a_1}+\frac{2a_2^2}{27a_1^2}$.
...
&=3z\int_{\mathcal{C}_1+\frac{a_2}{3a_1}}(a_1t^3+a_4)e^{-(a_1t^3+q)z}dt-3a_4z\int_{\mathcal{C}_1+\frac{a_2}{3a_1}}e^{-(a_1t^3+q)z}dt\\
&=-3zI'(z)-3a_4I(z)
\end{align*}
\end{proof}
