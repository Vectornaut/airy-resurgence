...
However, if $f(z)=\sum_{n\geq 0}a_nz^{-n}$ is a Gevrey-$1$ series, and $\alpha$ is a rational number with denominator $q$, then $\mathcal{B}(z^{-\alpha}f)(\zeta)$ is a germ of meromorphic function at the oringin of the Riemann surface of $\zeta^{1/q}$. Indeed,
\begin{align*}
...
\end{align*}
If $\alpha > 1$, then $\mathcal{B}(z^{-\alpha}f)(\zeta)$ is actually a germ of holomorphic functions on the Riemann surface of $\zeta
