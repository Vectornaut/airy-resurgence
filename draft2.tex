...
\end{align*} 
\color{VioletRed}
However, if $\tilde{\Phi}(z)=\sum_{n\geq 0}a_nz^{-n}$ is a Gevrey-$1$ series, then the Borel transform of $\mathcal{B}(z^{-\alpha}\Phi)(\zeta)$ is a germ of meromorphic function at the oringin: indeed 
\begin{align*}
