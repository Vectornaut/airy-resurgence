...
& = \Gamma\big(-\tfrac{1}{2}\big)\int_{\zeta_\alpha}^\zeta (\zeta-\zeta')^{-1/2}\textcolor{red}{\partial_{\zeta'}\left(\left[\frac{\nu}{df}\right]_{\operatorname{start} \mathcal{C}_\alpha(\zeta')}^{\operatorname{end} \mathcal{C}_\alpha(\zeta')} \right)}\,d\zeta',
\end{align*}
