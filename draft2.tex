...
\end{equation}
\end{proof}
Given an exponential integral
\[ J(z) = \int_\Gamma e^{-fz} \]
where $f$ projects $\Gamma$ to a Hankel contour, the argument above shows that $\hat{J}$ is the $\frac{3}{2}$-derivative of $(f')^{-1}$.
...
\end{align*}
however, ${}_2F_1\left(\frac{7}{6},\frac{11}{6};2;\frac{1}{2}+\frac{\zeta}{4}\right)$ has a branch cut at $\zeta\in(2/3,+\infty)$. 
...
\end{align*}
however ${}_2F_1\left(\frac{3}{2},\frac{3}{2};2;\frac{1}{2}+\frac{\zeta}{4}\right)$ has a branch cut at $\zeta\in(2,+\infty)$. 
\end{proof}
