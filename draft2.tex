...
\end{align*}
Continue $w_5$ and $w_6$ clockwise around their singularities at zero.} Notice that $|y - x| = y - x$ on the integration path.
\begin{align*}
&=\frac{8\pi}{27} \Gamma(\tfrac{5}{2}) \int_0^x |y-x|^{-1/2}\left[ e^{-(1/3) \pi i} \frac{|y|^{-5/3} {}_2F_1\left(\frac{5}{3},\frac{1}{6};\frac{1}{3};\frac{1}{y}\right)}{\Gamma(\tfrac{7}{3}) \Gamma(\tfrac{1}{3}) \Gamma(\tfrac{5}{6})} \right. \\
