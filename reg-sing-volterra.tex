...
\end{align*}
for any integration path that stays within $\near$. Taking advantage of the fact that $\near$ is a sector of a disk, let's use the straight-line path $\zeta = t \zeta(a)$, with $t \in (0, 1]$.
\begin{align*}
...
\end{align*}
Since we set $\sigma < \rho$, this brings us halfway to proving that $\volterra$ is a contraction of $\singexp{\rho-1}{\Lambda}$.
